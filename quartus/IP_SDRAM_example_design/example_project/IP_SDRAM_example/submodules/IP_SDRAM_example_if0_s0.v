...
`timescale 1 ps / 1 ps
module IP_SDRAM_example_if0_s0 (
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (12288),
		.INIT_FILE        ("IP_SDRAM_example_if0_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	IP_SDRAM_example_if0_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	IP_SDRAM_example_if0_s0_mm_interconnect_1 mm_interconnect_1 (
		.avl_clk_out_clk_clk                             (avl_clk),                                                   //                           avl_clk_out_clk.clk
	...
	IP_SDRAM_example_if0_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
