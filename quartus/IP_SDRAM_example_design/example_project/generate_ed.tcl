...
lappend arg_list "--report-file=csv:IP_SDRAM_example.csv"
lappend arg_list "--report-file=qip:IP_SDRAM_example.qip"
lappend arg_list "--output-name=IP_SDRAM_example"
...
lappend arg_list "--component-param=MEM_CLK_FREQ=167.0"
...
catch { eval [concat [list exec "/home/apistol/intelFPGA_lite/21.1/quartus//sopc_builder/bin/ip-generate" --component-name=alt_mem_if_lpddr2_tg_ed] $arg_list] } temp
puts $temp
