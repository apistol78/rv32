// IP_SDRAM_s0_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module IP_SDRAM_s0_mm_interconnect_1 (
	...
	IP_SDRAM_s0_mm_interconnect_1_router router (
	...
	IP_SDRAM_s0_mm_interconnect_1_router_001 router_001 (
	...
	IP_SDRAM_s0_mm_interconnect_1_router_001 router_002 (
	...
	IP_SDRAM_s0_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (avl_clk_out_clk_clk),                             //        clk.clk
		.reset              (trk_mm_bridge_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	IP_SDRAM_s0_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (avl_clk_out_clk_clk),                             //       clk.clk
		.reset               (trk_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IP_SDRAM_s0_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (avl_clk_out_clk_clk),                             //       clk.clk
		.reset               (trk_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IP_SDRAM_s0_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (avl_clk_out_clk_clk),                             //       clk.clk
		.reset              (trk_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IP_SDRAM_s0_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (avl_clk_out_clk_clk),                             //       clk.clk
		.reset              (trk_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IP_SDRAM_s0_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (avl_clk_out_clk_clk),                             //       clk.clk
		.reset               (trk_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
