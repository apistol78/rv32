...
verilator --trace --cc -Icode/Rv32H -D__VERILATOR__ -D__TESTBENCH__ -Wno-WIDTH -Wno-WIDTHCONCAT --Mdir code/Verify/SoC --top-module SoC code/Rv32H/SoC.sv
if [ $? -ne 0 ]; then
	exit 1
fi

mkdir -p code/Rv32T/SoC
verilator --trace --cc -Icode/Rv32H -D__VERILATOR__ -D__TESTBENCH__ -Wno-WIDTH -Wno-WIDTHCONCAT --Mdir code/Rv32T/SoC --top-module SoC code/Rv32H/SoC.sv
if [ $? -ne 0 ]; then
	exit 1
fi
