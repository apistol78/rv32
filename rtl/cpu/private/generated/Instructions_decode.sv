...
wire is_FCVT_S_WU = ((`INSTRUCTION & 32'hfff0007f) == 32'hd0100053);
...
wire is_FLE       = ((`INSTRUCTION & 32'hfe00707f) == 32'ha0000053);
wire is_FLT       = ((`INSTRUCTION & 32'hfe00707f) == 32'ha0001053);
wire is_FLW       = ((`INSTRUCTION & 32'h0000707f) == 32'h00002007);
wire is_FMADD     = ((`INSTRUCTION & 32'h0600007f) == 32'h00000043);
wire is_FMSUB     = ((`INSTRUCTION & 32'h0600007f) == 32'h00000047);
wire is_FNMADD    = ((`INSTRUCTION & 32'h0600007f) == 32'h0000004f);
wire is_FNMSUB    = ((`INSTRUCTION & 32'h0600007f) == 32'h0000004b);
wire is_FMIN      = ((`INSTRUCTION & 32'hfe00707f) == 32'h28000053);
wire is_FMAX      = ((`INSTRUCTION & 32'hfe00707f) == 32'h28001053);
...
wire is_FSGNJ     = ((`INSTRUCTION & 32'hfe00707f) == 32'h20000053);
wire is_FSGNJN    = ((`INSTRUCTION & 32'hfe00707f) == 32'h20001053);
wire is_FSGNJX    = ((`INSTRUCTION & 32'hfe00707f) == 32'h20002053);
...
wire is_J = is_JAL;
wire is_R = is_ADD | is_AND | is_DIV | is_DIVU | is_FADD | is_FCVT_W_S | is_FCVT_S_W | is_FCVT_S_WU | is_FDIV | is_FEQ | is_FLE | is_FLT | is_FMIN | is_FMAX | is_FMUL | is_FMV_X_W | is_FMV_W_X | is_FSGNJ | is_FSGNJN | is_FSGNJX | is_FSUB | is_MUL | is_MULH | is_MULHU | is_OR | is_REM | is_REMU | is_SLL | is_SLLI | is_SLT | is_SLTU | is_SRA | is_SRAI | is_SRL | is_SRLI | is_SUB | is_XOR;
...
wire is_FPU = is_FADD | is_FCVT_W_S | is_FCVT_S_W | is_FCVT_S_WU | is_FDIV | is_FEQ | is_FLE | is_FLT | is_FMADD | is_FMSUB | is_FNMADD | is_FNMSUB | is_FMIN | is_FMAX | is_FMUL | is_FMV_X_W | is_FMV_W_X | is_FSGNJ | is_FSGNJN | is_FSGNJX | is_FSUB;
