...
wire is_J = is_JAL;
wire is_R = is_ADD | is_AND | is_DIV | is_DIVU | is_FADD | is_FDIV | is_FMUL | is_FSUB | is_MUL | is_MULH | is_MULHU | is_OR | is_REM | is_REMU | is_SLL | is_SLLI | is_SLT | is_SLTU | is_SRA | is_SRAI | is_SRL | is_SRLI | is_SUB | is_XOR;
...
wire is_FPU = is_FADD | is_FDIV | is_FMUL | is_FSUB;
