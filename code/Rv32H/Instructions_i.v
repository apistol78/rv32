...
wire is_DIVUW  = ((`INSTRUCTION & 32'hfe00707f) == 32'h0200503b);
wire is_DIVW   = ((`INSTRUCTION & 32'hfe00707f) == 32'h0200403b);
...
wire is_J = is_JAL;
wire is_R = is_ADD | is_ADDW | is_AND | is_DIV | is_DIVU | is_DIVUW | is_DIVW | is_MUL | is_MULH | is_MULHU | is_OR | is_REM | is_REMU | is_SLL | is_SLLI | is_SLT | is_SLTU | is_SRA | is_SRAI | is_SRL | is_SRLI | is_SUB | is_XOR;
